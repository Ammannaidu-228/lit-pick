...
function Footer() {
  return (
    <div>
      <footer className="footer sm:footer-horizontal bg-gray-900 text-neutral-content items-center p-4">
        <aside className="grid-flow-col items-center">
          <div className="relative size-10 rounded-xl mx-2 bg-gradient-to-br from-violet-500 via-purple-500 to-pink-500 p-[1px] overflow-hidden shadow-lg shadow-purple-500/20">
            ...
            <div className="relative h-full w-full rounded-xl bg-gray-900 flex items-center justify-center overflow-hidden">
              <div className="relative flex items-center justify-center w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(120,119,198,0.2),rgba(255,255,255,0))]">
                <span className="text-transparent bg-clip-text bg-gradient-to-br from-violet-400 via-purple-400 to-pink-400 font-black text-2xl tracking-wider transform group-hover:scale-110 transition-transform duration-500">
                  L
                </span>
              </div>
            </div>
